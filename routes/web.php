...
Route::post('/contact', [\App\Http\Controllers\PageController::class, 'submitContact'])->middleware('throttle:5,1')->name('contact.submit');
...
Route::prefix('admin')->middleware(['auth', 'verified', 'admin'])->name('admin.')->group(function () {
    ...
    Route::post('/content/services', [\App\Http\Controllers\Admin\WebsiteContentController::class, 'updateServices'])->name('content.updateServices');
    ...
    Route::post('/content/clients', [\App\Http\Controllers\Admin\WebsiteContentController::class, 'updateClients'])->name('content.updateClients');
