                    ...
                    <div class="md:col-span-2 space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="title_en" name="title_en" type="text" value="{{ old('title_en', $blog->title_en) }}" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="content_en" id="content_en" value="{{ old('content_en', $blog->content_en) }}">
                            <div id="editor_en" class="min-h-[400px] rounded-b-lg border-gray-300">{!! old('content_en', $blog->content_en) !!}</div>
                        </div>
                    </div>
