        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/50 border-b border-gray-100 text-sm font-semibold text-gray-500">
                                <th class="p-6">Ikon</th>
                                <th class="p-6">Judul Layanan</th>
                                <th class="p-6">Deskripsi Singkat</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @foreach($services as $service)
                                <tr class="hover:bg-gray-50/30 transition-colors">
                                    ...
                                    <td class="p-6 font-semibold text-gray-900 text-lg">
                                        {{ $service->title }}
                                        <span class="block text-sm text-gray-500 font-normal mt-0.5">EN: {{ $service->title_en ?? '-' }}</span>
                                    </td>
                                    <td class="p-6 text-gray-600 text-base max-w-sm truncate">
                                    ...
                                    <td class="p-6 text-right">
                                        <div class="inline-flex gap-2">
                                            <a href="{{ route('admin.services.edit', $service) }}" class="inline-flex items-center px-3 py-2 bg-blue-50 text-blue-600 font-semibold rounded-lg hover:bg-blue-100 transition-colors text-base">
            ...
            @else
                <div class="p-16 text-center">
                    <x-lucide-package class="w-16 h-16 text-gray-300 mx-auto mb-4" />
