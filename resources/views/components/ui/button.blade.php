...
@php
    $baseClasses = 'inline-flex items-center justify-center font-semibold rounded-DEFAULT transition-all duration-fast focus:outline-none focus:ring-2 focus:ring-offset-2';
    
    $variants = [
        'primary' => 'bg-secondary text-white hover:bg-secondary-container hover:shadow-hover active:scale-95 focus:ring-secondary',
        ...
        'error' => 'bg-error text-white hover:bg-error-container hover:text-on-error-container hover:shadow-hover active:scale-95 focus:ring-error',
    ];
