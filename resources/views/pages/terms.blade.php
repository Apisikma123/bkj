<x-public-layout>
    ...
    <x-slot name="description">Syarat dan Ketentuan Layanan Bintang Kepri Jaya (BKJ Group).</x-slot>
    
    <x-seo.meta title="{{ __('messages.terms_of_service') }}" description="Syarat dan Ketentuan Layanan Bintang Kepri Jaya (BKJ Group)." />
    ...
    <section class="py-32 bg-surface min-h-screen">
        <x-layout.container class="max-w-4xl bg-white p-12 rounded-[2rem] shadow-ambient border border-outline-variant/30">
            ...
            <div class="prose prose-lg prose-p:text-on-surface-variant max-w-none">
                ...
                <p>Selamat datang di situs web Bintang Kepri Jaya. Syarat dan Ketentuan ini mengatur penggunaan Anda atas situs web kami. Dengan mengakses dan menggunakan situs ini, Anda menerima dan setuju untuk terikat oleh Syarat dan Ketentuan ini.</p>
