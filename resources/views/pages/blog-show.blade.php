<x-public-layout>
    ...
    <article class="pt-32 pb-32 bg-surface min-h-screen">
        <x-layout.container>
            <div class="max-w-4xl mx-auto">
                ...
                <h1 class="text-display-lg font-bold text-primary leading-tight mb-8">{{ $blogTitle }}</h1>
                
                <div class="flex items-center gap-6 mb-12 border-b border-outline-variant/30 pb-8">
                ...
                @if($blog->thumbnail)
                    <div class="w-full h-[400px] md:h-[600px] rounded-3xl overflow-hidden shadow-ambient mb-16">
